...
def main():
    ...
    parser.add_argument('--data-dirpath', dest='data_dirpath', nargs='?', help='data dirpath; default /data/icwsm2020_tumblr_identity/sample1k', default='/data/icwsm2020_tumblr_identity/sample1k')
    parser.add_argument('--output-dirpath', dest='output_dirpath', nargs='?', help='output dirpath; default /projects/icwsm2020_tumblr_identity', default='/projects/icwsm2020_tumblr_identity')
